<div align="center">
  <h1>Hi there, I'm Bryan Alegría 👋</h1>
...
#### 🏦 NUAM Financial Dashboard (Academic)
*Backend Lead*
Designed a prototype for financial data visualization using **Python (Pandas)** for data cleaning and **Django** to serve the API.
* **Tech:** Python, Django, Pandas.

#### 📦 StockBry - Inventory Management
